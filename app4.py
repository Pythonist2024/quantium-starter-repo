...
app.layout = html.Div(style = {"backgroundColor" : "#664902", "border-radius" : "20px"},
    children = [
    html.H1("Pink Morsel Visualization", style = {"color" : "#0A1A09", "textAlign" : "center", 
            "background-color": "#664902", "border-radius" : "20px"}),
    dcc.Graph(id = "all_draw", figure = fig),
    dcc.RadioItems(["north", "east", "south", "west", "all"], "all", id = "select_location", inline = True, 
    style = {"font-size":"200%", "textAlign":"center", "color":"#173814", "font-weight":"bold"})
    ])          
